    ...
    <div class="welcome-container">
        ...
        <div class="welcome-container">
            <div class="welcome-header">
                <h1>
                    <i class="fas fa-cube"></i> {{ config('app.name', 'Inventory') }}
                </h1>
                <p>Sistem Manajemen Persediaan Barang Modern</p>
            </div>
            ...
            <div class="feature-grid">
                <div class="feature-card">
                    ...
                    <p>Kelola semua produk Anda dengan mudah dan efisien</p>
                </div>
                ...
                <div class="feature-card">
                    ...
                    <h3>Tracking Stok</h3>
                    <p>Pantau stok barang secara real-time dengan akurat</p>
                </div>
                ...
                <div class="feature-card">
                    ...
                    <h3>Pergerakan Barang</h3>
                    <p>Catat dan analisis setiap pergerakan barang</p>
                </div>
                ...
                <div class="feature-card">
                    ...
                    <h3>Backup Data</h3>
                    <p>Backup otomatis untuk keamanan data Anda</p>
                </div>
            </div>
            ...
            <div class="info-section">
                ...
                <ul class="info-list">
                    <li>
                        ...
                        <span><strong>Dashboard Intuitif</strong> - Visualisasi data yang jelas dan mudah
                            dipahami</span>
                    </li>
                    <li>
                        <i class="fas fa-check-circle"></i>
                        <span><strong>Laporan Lengkap</strong> - Buat laporan stok dan pergerakan barang</span>
                    </li>
                    <li>
                        <i class="fas fa-check-circle"></i>
                        <span><strong>Multi-user</strong> - Akses untuk berbagai tingkat pengguna</span>
                    </li>
                    <li>
                        <i class="fas fa-check-circle"></i>
                        <span><strong>Sinkronisasi</strong> - Sinkron dengan sistem penyimpanan Anda</span>
                    </li>
                    <li>
                        <i class="fas fa-check-circle"></i>
                        <span><strong>Keamanan</strong> - Autentikasi dan enkripsi data terjamin</span>
                    </li>
                    <li>
                        <i class="fas fa-check-circle"></i>
                        <span><strong>Support</strong> - Tim support siap membantu Anda</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="action-buttons">
                @if (Route::has('login'))
                    @auth
                        <a href="{{ url('/dashboard') }}" class="btn-welcome btn-welcome-primary">
                    ...
                    @else
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="btn-welcome btn-welcome-outline">
...
<div
    class="bg-[#fff2f2] dark:bg-[#1D0002] relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-335/376 lg:aspect-auto w-full lg:w-md shrink-0 overflow-hidden">
    {{-- Laravel Logo --}}
    ...
    {{-- Light Mode 12 SVG --}}
    <svg class="w-md max-w-none relative -mt-[4.9rem] -ml-8 lg:ml-0 lg:-mt-[6.6rem] dark:hidden" viewBox="0 0 440 376"
